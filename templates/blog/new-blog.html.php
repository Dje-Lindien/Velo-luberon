...
<div class="mx-7 pb-5">
    <div class="w-50 py-1 px-5 mb-4" style="background-color: #e6232b;">
        <h2 style="color:antiquewhite;">Ajouter un article de blog :</h2>
        <span class="border-bottom"></span>
    </div>
</div>
<!-- Formulaire d'ajout blog  -->
<div id="form-new-blog" class="container">
    <div class="row m-5">
        ...
        <form action=""  enctype="multipart/form-data" method="POST">
            <div>
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="newtitre" placeholder="Titre de l'article">
                    <input type="text" class="form-control w-100 mt-1" name="newtexte" placeholder="Article..." style="height:350px;">
                </div>
                <div class="col-sm-8 row justify-content-between p-3">
                    ...
                    <div class="col-1">
                        <button type="submit" id="btn-valider" class="btn btn-danger mx-2" name="newBlog" style="font-size: 1.2rem;">Valider</button>  
                    </div>           
                </div>
            </div>
        </form>
